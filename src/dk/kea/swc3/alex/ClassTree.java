...
public class ClassTree {
    ...
    /**
     * <p>
     * Build breadth first in order to maintain sudo ordering as per class
     * declarations (i.e. if A implements B, C... B is closer in the chain to A
     * than C is, because B comes first in the implements clause.</p>
     *
     * <p>
     * Note that the list coming out here is preordered, but not natural
     * ordered. (i.e. some classes are out of order in relation to classes they
     * have direct relationships with. This is later fixed by a sort on the list
     * by natural ordering. Collecitons.sort, does preserve the preordering for
     * nodes that have no relationship.</p>
     *
     * @param node the node to be browsed.
     * @param output this list is altered to add the contents as they are
     * browsed in breadth-first order. Start with a list containing only the
     * bottom node.
     */
    ...
    public static class ClassTreeNode implements Comparable {
        ...
        /**
         * <p>
         * Constructs a ClassTreeNode with the given Class.</p>
         *
        ...
        /**
         * <p>
         * Compares one class to another class by their inheritance tree.</p>
         *
         * @return an integer representing the comparison results as
         * follows:<br>
